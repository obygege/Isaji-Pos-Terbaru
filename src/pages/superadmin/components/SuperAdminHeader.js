...
function SuperAdminHeader({ searchQuery, setSearchQuery, onProfileClick }) {
    return (
        <header className="bg-white/80 backdrop-blur-md border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-40">
            <div>
                ...
                <p className="text-xs font-medium text-gray-500">Infrastruktur Global Isaji POS</p>
            </div>
            ...
            <div className="flex items-center gap-6">
                <div className="hidden md:flex items-center bg-gray-50 border border-gray-200 rounded-xl px-4 py-2 focus-within:border-isaji-orange focus-within:ring-2 focus-within:ring-orange-100 transition-all">
                    ...
                    <input
                        ...
                        placeholder="Cari tenant atau domain..."
                        className="bg-transparent text-sm text-gray-900 outline-none w-56 placeholder-gray-400"
                    />
                </div>

                <button onClick={onProfileClick} className="flex items-center gap-3 pl-6 border-l border-gray-200 hover:opacity-80 transition-opacity">
                    <div className="text-right hidden md:block">
                        <p className="text-sm font-black text-gray-900">Super Admin</p>
                        <p className="text-[10px] text-isaji-orange font-bold uppercase">Pemilik Sistem</p>
                    </div>
